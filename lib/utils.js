...
/**
 * Determine if string is a valid unicode emoji
 *
...
function validEmoji(emoji) {
  try {
    return emoji.match(emojiRegex)[0] !== null
  } catch (e) {
    return false
  }
}
 ...
 * @param {boolean} [sameAuthor=true] Whether the answer should be from the same author as the initial message
